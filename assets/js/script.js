var canadaBtn = document.getElementById("canada").addEventListener("click", function(){
    //canada new years fetch
        fetch("https://youtube-v31.p.rapidapi.com/search?q=canada%20new%20years&part=snippet%2Cid&regionCode=US&maxResults=4&order=relevance", {
        "method": "GET",
        "headers": {
